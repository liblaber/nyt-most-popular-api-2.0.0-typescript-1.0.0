 ...
 */
export const emailedArticle = z.object({
...
/**
 *
 * @typedef  {EmailedArticle} emailedArticle
 ...
 */
export type EmailedArticle = z.infer<typeof emailedArticle>;

/**
 * The shape of the model mapping from the api schema into the application shape.
 * Is equal to application shape if all property names match the api schema
 */
export const emailedArticleResponse = z
  .object({
    url: z.string().optional(),
 ...
 * Is equal to application shape if all property names match the api schema
 */
export const emailedArticleRequest = z
  .object({
